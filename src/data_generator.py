...
def main():
    ...
    save_json(drones, Path("../data/drones_s1.json"))
    save_json(deliveries, Path("../data/deliveries_s1.json"))
    save_json(zones, Path("../data/nofly_s1.json"))
    print("Örnek veri seti data/ klasörüne kaydedildi.")
